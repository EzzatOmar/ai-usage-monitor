...
- [GitHub Actions release run](https://github.com/EzzatOmar/ai-usage-monitor/actions/runs/32145193114)
  - Result: passed — the macOS 14 runner compiled, packaged, and published v0.1.19.
- Public download of `AIUsageMonitor-0.1.19.dmg`, followed by `shasum -a 256` and `hdiutil verify`.
  - Result: passed — the published DMG is valid and its SHA-256 matches GitHub's digest: `06a1d74007dd08914c8d6a27c9796bb47680e1a69a5a889c9b8c4f1907a2dfa2`.
...
- 2026-08-18 — Published [v0.1.19](https://github.com/EzzatOmar/ai-usage-monitor/releases/tag/v0.1.19); the release workflow and public DMG integrity verification passed.
