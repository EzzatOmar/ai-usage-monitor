...
- [x]: [B3](b/B3.md) - resize usage menu and keep website downloads current
- [x]: [B4](b/B4.md) - explicitly resize the menu window after provider toggles
...
- [x]: [A5](a/A5.md) - monitor OpenCode Go subscription usage
