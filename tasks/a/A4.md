...
- [x] Build, package, release, and verify the public artifact.
...
- [GitHub Actions release run](https://github.com/EzzatOmar/ai-usage-monitor/actions/runs/32152594300)
  - Result: passed — the macOS 14 runner compiled, packaged, and published v0.1.20.
- Public download of `AIUsageMonitor-0.1.20.dmg`, followed by `shasum -a 256` and `hdiutil verify`.
  - Result: passed — the published DMG is valid and its SHA-256 matches GitHub's digest: `36d7f2ec57e7386a34be0ed837d4a42bc1b869cbb3ab7ecade7868b7754d3d40`.
...
- 2026-08-18 — Published [v0.1.20](https://github.com/EzzatOmar/ai-usage-monitor/releases/tag/v0.1.20); release CI and the downloaded public DMG passed integrity verification.
